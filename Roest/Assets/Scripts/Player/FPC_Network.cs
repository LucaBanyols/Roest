...
public class FPC_Network : NetworkBehaviour
{
    ...
    public PlayerObjectManagement playerObjectManagement;
    ...
    private void Update()
    {
        ...
        if (isOwned && !isAttacking && Input.GetKeyDown(KeyCode.Mouse0))
        {
            CmdAttack();
        }
    ...
    {
        playerAnimator.SetLayerWeight(playerAnimator.GetLayerIndex("Attack Layer"), 1);
        playerAnimator.SetTrigger("AttackTrigger");
        handCollider.enabled = true;
        isAttacking = true;
        yield return new WaitForSeconds(0.9f);
        playerAnimator.SetLayerWeight(playerAnimator.GetLayerIndex("Attack Layer"), 0);
        handCollider.enabled = false;
        isAttacking = false;
        hitArea.setHasAttack(false);
    }
    ...
    // {
    //     Debug.Log("CMD Player take damage");
    ...
    // {
    //     Debug.Log("RPC Player take damage");
    //     TakeDamage(damage);
    // }
    ...
    void OnHealthChanged(float oldValue, float newValue)
    {
        ...
        if (newValue <= 0 && isOwned)
        {
            // Respawn
            // playerObjectManagement.Drop();
            if (isOwned)
            {
    ...
    private IEnumerator DeathCoroutine()
    {
        ...
        playerAnimator.SetTrigger("isRespawn");
...
// Custom Editor
#if UNITY_EDITOR
[CustomEditor(typeof(FPC_Network)), InitializeOnLoadAttribute]
public class FPC_NetworkEditor : Editor
{
    FPC_Network fpc;
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.audioListener = (AudioListener)EditorGUILayout.ObjectField(new GUIContent("Audio Listener", "Audio Listener attached to the controller."), fpc.audioListener, typeof(AudioListener), true);
        fpc.playerAnimator = (Animator)EditorGUILayout.ObjectField(new GUIContent("Animator", "Animator attached to the controller."), fpc.playerAnimator, typeof(Animator), true);
        ...
        EditorGUILayout.Space();
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Health Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();

        fpc.health = EditorGUILayout.Slider(new GUIContent("Health", "Determines the current health of the player."), fpc.health, 0, 100);
        fpc.playerObjectManagement = (PlayerObjectManagement)EditorGUILayout.ObjectField(new GUIContent("Player Object Management", "Player Object Management attached to the controller."), fpc.playerObjectManagement, typeof(PlayerObjectManagement), true);
        ...
        EditorGUILayout.Space();
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Attack Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();

        fpc.handCollider = (SphereCollider)EditorGUILayout.ObjectField(new GUIContent("Hand Collider", "Collider attached to the right hand."), fpc.handCollider, typeof(SphereCollider), true);
        fpc.hitArea = (HitArea)EditorGUILayout.ObjectField(new GUIContent("Hit Area", "Hit area attached to the right hand."), fpc.hitArea, typeof(HitArea), true);
        ...
        fpc.inventory = (InventoryObject)EditorGUILayout.ObjectField(new GUIContent("Inventory", ""), fpc.inventory, typeof(InventoryObject), true);
        fpc.inventoryUI = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Inventory UI", ""), fpc.inventoryUI, typeof(GameObject), true);
        fpc.Wrist_R = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Wrist_R", ""), fpc.Wrist_R, typeof(GameObject), true);
        fpc.quitUI = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Quit UI", ""), fpc.quitUI, typeof(GameObject), true);
        #endregion
